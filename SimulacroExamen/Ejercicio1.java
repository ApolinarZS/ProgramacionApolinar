...
public class Ejercicio1 {
    public static void main (String[] args) {
        ...
        System.out.println("¿A qué sección quieres acceder?\n" +
        ...
        switch (menu){
            ...
            case "a"->{
                ...
                do{
                    ...
                    while (n > 10){//si son mayores de 10 volvemos a pedirselas al usuario
            ...
            case "b"->{
                ...
                for (int i = 1; i <= nfamilia ; i++) {
                    ...
                    //segçun la edad introducida, sumamos un valor u otro al coste total
                    if (edad > 15 && edad < 65){
